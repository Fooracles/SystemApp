...
export function StepNode({ id, data, selected }) {
  ...
  return (
    <div className={`fms-node fms-node-step ${selected ? 'selected' : ''}`}>
      ...
      <div className="fms-node-badge fms-badge-step">Step</div>
      <div className="fms-node-title">{data?.stepName || 'Step'}</div>
