<?php
/**
 * Simple Leave Requests Sync Script
 * Syncs data from Google Sheets to database without U2/V2 checks
 * Processes only a limited number of records to avoid timeouts
 */
...
try {
    ...
    logSync("Starting simple leave sync for sheet: $sheet_id, tab: $tab_name");
    ...
    logSync("Simple sync completed. Synced: $synced_count records");
    ...
    logSync("Simple sync failed: " . $e->getMessage());
